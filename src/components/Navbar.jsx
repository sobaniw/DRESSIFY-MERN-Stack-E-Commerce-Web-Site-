...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 px-6 font-medium'>
      ...
      {/* Logo */}
      <Link to='/' className='text-2xl font-bold tracking-widest text-black cursor-pointer'>
        DRESSIFY.
      </Link>
      ...
      <div className='flex items-center gap-6 relative'>
        ...
        <Link to='/'><img src={assets.search_icon} alt="search" className='w-5 cursor-pointer' /></Link>
